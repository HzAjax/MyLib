...
public class BaseExceptionHandler {
    ...
    protected ErrorMessageDto buildError(String message, HttpStatus status, WebRequest request) {
    ...
    protected ErrorMessageDto buildError(String message, HttpStatus status, WebRequest request, ErrorMessageDto details) {
        return ErrorMessageDto.builder()
                .message(message)
                .status(status.value())
                .timestamp(LocalDateTime.now())
